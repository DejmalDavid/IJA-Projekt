...
/**
 * Graficke zobrazeni bloku rozdil
 * @author Michal Beranek(xberan38)
 */
public class GBlock_rozdil extends GBlock{
     ...
     * @param id id bloku
     */
    public GBlock_rozdil(double transx, double transy, int id) {
        super(id);
        Main.id += 1;
        if(Main.plan1.add_block(Integer.toString(id), "rozdil", hodnoty.Metr)) {
            ...
            GBlock_rozdil.setAlignment(port_out1, Pos.CENTER_RIGHT);
            GBlock_rozdil.setAlignment(port_in1, Pos.CENTER_LEFT);
            GBlock_rozdil.setAlignment(port_in2, Pos.BOTTOM_LEFT);
            GBlock_rozdil.setAlignment(op, Pos.TOP_CENTER);
        }
