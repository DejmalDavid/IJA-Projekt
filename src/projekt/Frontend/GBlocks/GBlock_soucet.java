...
/**
 * Graficke zobrazeni bloku soucet
 * @author Michal Beranek(xberan38)
 */
public class GBlock_soucet extends GBlock{
    ...
    public GBlock_soucet(double transx, double transy, int id){
        ...
        if(Main.plan1.add_block(Integer.toString(id), "soucet", hodnoty.Metr)) {
            ...
            GBlock_soucet.setAlignment(port_out1, Pos.CENTER_RIGHT);
            GBlock_soucet.setAlignment(port_in1, Pos.CENTER_LEFT);
            GBlock_soucet.setAlignment(port_in2, Pos.BOTTOM_LEFT);
            GBlock_soucet.setAlignment(op, Pos.TOP_CENTER);
        }
