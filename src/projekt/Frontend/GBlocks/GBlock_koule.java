...
/**
 * Graficke zobrazeni bloku koule
 * @author Michal Beranek(xberan38)
 */
public class GBlock_koule extends GBlock{
    ...
    public GBlock_koule(double transx, double transy, int id){
        ...
        if(Main.plan1.add_block(Integer.toString(id), "koule", hodnoty.Metr)) {
            ...
            GBlock_koule.setAlignment(port_out2, Pos.BOTTOM_RIGHT);
            GBlock_koule.setAlignment(port_out3, Pos.TOP_RIGHT);
            GBlock_koule.setAlignment(op, Pos.TOP_CENTER);
        }
