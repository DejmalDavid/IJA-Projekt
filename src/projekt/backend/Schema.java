      ...
      public boolean add_block(String nazev,String typ_bloku,hodnoty typ)
      {
    	  ...
    	  switch(typ_bloku)
    	  {
              ...
              case "rozdil" :
    	  		...
    	  		break;
              case "soucin" :
   	  		 	jedna = new Block_soucin(nazev,bloky.size(),typ);
   	  		 	break;
              case "koule":
                jedna = new Block_koule(nazev, bloky.size());
			  	break;
              case "kvadr":
                  jedna = new Block_koule(nazev, bloky.size());
                  break;
              case "obdelnik":
                  jedna = new Block_obdelnik(nazev, bloky.size());
                  break;
              case "podil":
                  jedna = new Block_podil(nazev, bloky.size(), typ);
                  break;
    	         	 ...
    	         	 {     		 
    	                 for(Wire propoj : propoje)	//projde vsechny bloky v zadanem poradi
    	                 {
	    	               	  if(propoj.start() == port)	//zadane id nalezeno
	    	               	  {
								  ...
								  propoj.set_port_end_null();
								  propoj.set_port_start_null();
	    	               		  break;
	    	               	  }
    	                 }
    	         	 }
